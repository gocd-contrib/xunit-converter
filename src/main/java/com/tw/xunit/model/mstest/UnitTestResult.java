...
public class UnitTestResult {
    ...
    public double getConvertedDuration() {
        return ConversionHelpers.durationConverter(duration);
    }

    public void setConvertedDuration(double d) {
        this.convertedDuration = d;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (Double.compare(that.convertedDuration, convertedDuration) != 0) return false;
        ...
        if (relativeResultsDirectory != null ? !relativeResultsDirectory.equals(that.relativeResultsDirectory) : that.relativeResultsDirectory != null)
            return false;
    ...
    public int hashCode() {
        ...
        temp = Double.doubleToLongBits(convertedDuration);
