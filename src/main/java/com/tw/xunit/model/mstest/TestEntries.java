...
public class TestEntries {
    ...
    public List<TestEntry> getTestEntries() {return testEntries; }
    public void setTestEntries(List<TestEntry> testEntries) { this.testEntries = testEntries; }

    @Override
    public boolean equals(Object o) {
        if (this == o) return  true;
        if(!(o instanceof TestEntries)) return  false;

        TestEntries that = (TestEntries) o;

        if (testEntries != that.testEntries) return false;
