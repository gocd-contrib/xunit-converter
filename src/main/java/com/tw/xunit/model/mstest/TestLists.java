...
public class TestLists {
    ...
    public List<TestList> getTestLists() {return testLists; }
    public void setTestLists(List<TestList> testLists) {this.testLists = testLists; }

    @Override
    public boolean equals(Object o){
        if (this == o) return true;
        if(!(o instanceof TestLists)) return false;

        TestLists that = (TestLists) o;
