...
public class TestCategory {
    ...
    public List<TestCategoryItem> getTestCategoryItemList() {
        return testCategoryItemList;
    }

    public void setTestCategoryItemList(List<TestCategoryItem> testCategoryItemList) {
        this.testCategoryItemList = testCategoryItemList;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (testCategoryItemList != null ? !testCategoryItemList.equals(that.testCategoryItemList) : that.testCategoryItemList != null)
            return false;
